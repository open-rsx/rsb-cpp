 ...
 *      Author: swrede
 *
*   Embedded webserver code -- largely based on mongoose example.
 */
		...
		void *user_data)
{
	...
	mg_printf(conn, "<p>Running RSB Version: %s ", (rsb::Version::string() + "</p>").c_str());
	mg_printf(conn, "%s",("<p>RSB Build information: Nr. " + rsb::Version::buildString() + "</p>").c_str());
