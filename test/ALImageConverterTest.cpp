...
//	cvWaitKey(0);
	...
	AL::ALImage *alimage1 = new AL::ALImage(AL::kQQVGA, AL::kRGBColorSpace, true);
	string s = "blabalbablablablabl";
	alimage1->setData((unsigned char*) s.c_str());
	{
		boost::shared_ptr<ALImage> alp(alimage1);
	}
//	cvShowImage("before", iplImage);
//	cvWaitKey(0);
